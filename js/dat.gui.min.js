...
'object'==typeof exports&&'object'==typeof module?module.exports=t():'function'==typeof define&&define.amd?define([], t):'object'==typeof exports?exports.dat=t():e.dat=t();
  ...
  return function(e) {
    function t(o) {
      if (n[o]) return n[o].exports; const i=n[o]={exports: {}, id: o, loaded: !1}; return e[o].call(i.exports, i, i.exports, t), i.loaded=!0, i.exports;
    } var n={}; return t.m=e, t.c=n, t.p='', t(0);
  }([function(e, t, n) {
    'use strict'; function o(e) {
      return e&&e.__esModule?e:{'default': e};
    } const i=n(1); const r=o(i); e.exports=r['default'];
  }, function(e, t, n) {
    'use strict'; function o(e) {
      return e&&e.__esModule?e:{'default': e};
    }t.__esModule=!0; const i=n(2); const r=o(i); const a=n(6); const l=o(a); const s=n(3); const u=o(s); const d=n(7); const c=o(d); const f=n(8); const _=o(f); const p=n(10); const h=o(p); const m=n(11); const b=o(m); const g=n(12); const v=o(g); const y=n(13); const w=o(y); const x=n(14); const E=o(x); const C=n(15); const A=o(C); const S=n(16); const k=o(S); const O=n(9); const T=o(O); const R=n(17); const L=o(R); t['default']={color: {Color: r['default'], math: l['default'], interpret: u['default']}, controllers: {Controller: c['default'], BooleanController: _['default'], OptionController: h['default'], StringController: b['default'], NumberController: v['default'], NumberControllerBox: w['default'], NumberControllerSlider: E['default'], FunctionController: A['default'], ColorController: k['default']}, dom: {dom: T['default']}, gui: {GUI: L['default']}, GUI: L['default']};
  }, function(e, t, n) {
    'use strict'; function o(e) {
      return e&&e.__esModule?e:{'default': e};
    } function i(e, t) {
    ...
    }t.__esModule=!0; const l=n(3); const s=o(l); const u=n(6); const d=o(u); const c=n(4); const f=o(c); const _=n(5); const p=o(_); var h=function() {
      function e() {
      ...
      const t=d['default'].rgb_to_hsv(e.r, e.g, e.b); p['default'].extend(e.__state, {s: t.s, v: t.v}), p['default'].isNaN(t.h)?p['default'].isUndefined(e.__state.h)&&(e.__state.h=0):e.__state.h=t.h;
    ...
    'use strict'; function o(e) {
      return e&&e.__esModule?e:{'default': e};
    }t.__esModule=!0; const i=n(4); const r=o(i); const a=n(5); const l=o(a); const s=[{litmus: l['default'].isString, conversions: {THREE_CHAR_HEX: {read: function(e) {
      const t=e.match(/^#([A-F0-9])([A-F0-9])([A-F0-9])$/i); return null!==t&&{space: 'HEX', hex: parseInt('0x'+t[1].toString()+t[1].toString()+t[2].toString()+t[2].toString()+t[3].toString()+t[3].toString(), 0)};
    }, write: r['default']}, SIX_CHAR_HEX: {read: function(e) {
      const t=e.match(/^#([A-F0-9]{6})$/i); return null!==t&&{space: 'HEX', hex: parseInt('0x'+t[1].toString(), 0)};
    }, write: r['default']}, CSS_RGB: {read: function(e) {
      const t=e.match(/^rgb\(\s*(.+)\s*,\s*(.+)\s*,\s*(.+)\s*\)/); return null!==t&&{space: 'RGB', r: parseFloat(t[1]), g: parseFloat(t[2]), b: parseFloat(t[3])};
    }, write: r['default']}, CSS_RGBA: {read: function(e) {
      const t=e.match(/^rgba\(\s*(.+)\s*,\s*(.+)\s*,\s*(.+)\s*,\s*(.+)\s*\)/); return null!==t&&{space: 'RGB', r: parseFloat(t[1]), g: parseFloat(t[2]), b: parseFloat(t[3]), a: parseFloat(t[4])};
    ...
    }}}}]; let u=void 0; let d=void 0; const c=function() {
      d=!1; const e=arguments.length>1?l['default'].toArray(arguments):arguments[0]; return l['default'].each(s, function(t) {
        if (t.litmus(e)) {
          return l['default'].each(t.conversions, function(t, n) {
    ...
    'use strict'; t.__esModule=!0, t['default']=function(e, t) {
      const n=e.__state.conversionName.toString(); const o=Math.round(e.r); const i=Math.round(e.g); const r=Math.round(e.b); const a=e.a; const l=Math.round(e.h); const s=e.s.toFixed(1); const u=e.v.toFixed(1); if (t||'THREE_CHAR_HEX'===n||'SIX_CHAR_HEX'===n) {
    ...
    'use strict'; t.__esModule=!0; const n=Array.prototype.forEach; const o=Array.prototype.slice; const i={BREAK: {}, extend: function(e) {
      return this.each(o.call(arguments, 1), function(t) {
        const n=this.isObject(t)?Object.keys(t):[]; n.forEach(function(n) {
      ...
      const e=o.call(arguments); return function() {
        for (var t=o.call(arguments), n=e.length-1; n>=0; n--)t=[e[n].apply(this, t)]; return t[0];
      };
    }, each: function(e, t, o) {
      if (e) {
        if (n&&e.forEach&&e.forEach===n)e.forEach(t, o); else if (e.length===e.length+0) {
          let i=void 0; let r=void 0; for (i=0, r=e.length; i<r; i++) if (i in e&&t.call(o, e[i], i)===this.BREAK) return;
        } else for (const a in e) if (t.call(o, e[a], a)===this.BREAK) return;
      }
    }, defer: function(e) {
      setTimeout(e, 0);
    }, debounce: function(e, t) {
      let n=void 0; return function() {
        function o() {
          n=null;
        } const i=this; const r=arguments; const a=!n; clearTimeout(n), n=setTimeout(o, t), a&&e.apply(i, r);
      };
    }, toArray: function(e) {
    ...
    'use strict'; t.__esModule=!0; let n=void 0; const o={hsv_to_rgb: function(e, t, n) {
      const o=Math.floor(e/60)%6; const i=e/60-Math.floor(e/60); const r=n*(1-t); const a=n*(1-i*t); const l=n*(1-(1-i)*t); const s=[[n, l, r], [a, n, r], [r, n, l], [r, a, n], [l, r, n], [n, r, a]][o]; return {r: 255*s[0], g: 255*s[1], b: 255*s[2]};
    }, rgb_to_hsv: function(e, t, n) {
      const o=Math.min(e, t, n); const i=Math.max(e, t, n); const r=i-o; let a=void 0; let l=void 0; return 0===i?{h: NaN, s: 0, v: 0}:(l=r/i, a=e===i?(t-n)/r:t===i?2+(n-e)/r:4+(e-t)/r, a/=6, a<0&&(a+=1), {h: 360*a, s: l, v: i/255});
    }, rgb_to_hex: function(e, t, n) {
      let o=this.hex_with_component(0, 2, e); return o=this.hex_with_component(o, 1, t), o=this.hex_with_component(o, 0, n);
    ...
    'use strict'; function n(e, t) {
      if (!(e instanceof t)) throw new TypeError('Cannot call a class as a function');
    }t.__esModule=!0; const o=function() {
      function e(t, o) {
    ...
    }t.__esModule=!0; const l=n(7); const s=o(l); const u=n(9); const d=o(u); const c=function(e) {
      function t(n, o) {
        function a() {
          s.setValue(!s.__prev);
        }i(this, t); const l=r(this, e.call(this, n, o)); var s=l; return l.__prev=l.getValue(), l.__checkbox=document.createElement('input'), l.__checkbox.setAttribute('type', 'checkbox'), d['default'].bind(l.__checkbox, 'change', a, !1), l.domElement.appendChild(l.__checkbox), l.updateDisplay(), l;
      } return a(t, e), t.prototype.setValue=function(t) {
        const n=e.prototype.setValue.call(this, t); return this.__onFinishChange&&this.__onFinishChange.call(this, this.getValue()), this.__prev=this.getValue(), n;
    ...
    'use strict'; function o(e) {
      ...
      if ('0'===e||a['default'].isUndefined(e)) return 0; const t=e.match(u); return a['default'].isNull(t)?0:parseFloat(t[1]);
    }t.__esModule=!0; const r=n(5); var a=o(r); const l={HTMLEvents: ['change'], MouseEvents: ['click', 'mousemove', 'mousedown', 'mouseup', 'mouseover'], KeyboardEvents: ['keydown']}; const s={}; a['default'].each(l, function(e, t) {
      a['default'].each(e, function(e) {
        s[e]=t;
      });
    }); var u=/(\d+(\.\d+)?)px/; var d={makeSelectable: function(e, t) {
      void 0!==e&&void 0!==e.style&&(e.onselectstart=t?function() {
        return !1;
      }:function() {}, e.style.MozUserSelect=t?'auto':'none', e.style.KhtmlUserSelect=t?'auto':'none', e.unselectable=t?'on':'off');
    }, makeFullscreen: function(e, t, n) {
      let o=n; let i=t; a['default'].isUndefined(i)&&(i=!0), a['default'].isUndefined(o)&&(o=!0), e.style.position='absolute', i&&(e.style.left=0, e.style.right=0), o&&(e.style.top=0, e.style.bottom=0);
    }, fakeEvent: function(e, t, n, o) {
      const i=n||{}; const r=s[t]; if (!r) throw new Error('Event type '+t+' not supported.'); const l=document.createEvent(r); switch (r) {
        case 'MouseEvents': var u=i.x||i.clientX||0; var d=i.y||i.clientY||0; l.initMouseEvent(t, i.bubbles||!1, i.cancelable||!0, window, i.clickCount||1, 0, 0, u, d, !1, !1, !1, !1, 0, null); break; case 'KeyboardEvents': var c=l.initKeyboardEvent||l.initKeyEvent; a['default'].defaults(i, {cancelable: !0, ctrlKey: !1, altKey: !1, shiftKey: !1, metaKey: !1, keyCode: void 0, charCode: void 0}), c(t, i.bubbles||!1, i.cancelable, window, i.ctrlKey, i.altKey, i.shiftKey, i.metaKey, i.keyCode, i.charCode); break; default: l.initEvent(t, i.bubbles||!1, i.cancelable||!0);
      }a['default'].defaults(l, o), e.dispatchEvent(l);
    }, bind: function(e, t, n, o) {
      const i=o||!1; return e.addEventListener?e.addEventListener(t, n, i):e.attachEvent&&e.attachEvent('on'+t, n), d;
    }, unbind: function(e, t, n, o) {
      const i=o||!1; return e.removeEventListener?e.removeEventListener(t, n, i):e.detachEvent&&e.detachEvent('on'+t, n), d;
    }, addClass: function(e, t) {
      if (void 0===e.className)e.className=t; else if (e.className!==t) {
        const n=e.className.split(/ +/); n.indexOf(t)===-1&&(n.push(t), e.className=n.join(' ').replace(/^\s+/, '').replace(/\s+$/, ''));
      } return d;
    }, removeClass: function(e, t) {
      if (t) {
        if (e.className===t)e.removeAttribute('class'); else {
          const n=e.className.split(/ +/); const o=n.indexOf(t); o!==-1&&(n.splice(o, 1), e.className=n.join(' '));
        }
      } else e.className=void 0; return d;
    }, hasClass: function(e, t) {
      return new RegExp('(?:^|\\s+)'+t+'(?:\\s+|$)').test(e.className)||!1;
    }, getWidth: function(e) {
      const t=getComputedStyle(e); return i(t['border-left-width'])+i(t['border-right-width'])+i(t['padding-left'])+i(t['padding-right'])+i(t.width);
    }, getHeight: function(e) {
      const t=getComputedStyle(e); return i(t['border-top-width'])+i(t['border-bottom-width'])+i(t['padding-top'])+i(t['padding-bottom'])+i(t.height);
    }, getOffset: function(e) {
      let t=e; const n={left: 0, top: 0}; if (t.offsetParent) do n.left+=t.offsetLeft, n.top+=t.offsetTop, t=t.offsetParent; while (t); return n;
    }, isActive: function(e) {
    ...
    'use strict'; function o(e) {
      ...
      if ('function'!=typeof t&&null!==t) throw new TypeError('Super expression must either be null or a function, not '+typeof t); e.prototype=Object.create(t&&t.prototype, {constructor: {value: e, enumerable: !1, writable: !0, configurable: !0}}), t&&(Object.setPrototypeOf?Object.setPrototypeOf(e, t):e.__proto__=t);
    }t.__esModule=!0; const l=n(7); const s=o(l); const u=n(9); const d=o(u); const c=n(5); const f=o(c); const _=function(e) {
      function t(n, o, a) {
        i(this, t); const l=r(this, e.call(this, n, o)); let s=a; const u=l; return l.__select=document.createElement('select'), f['default'].isArray(s)&&!function() {
          const e={}; f['default'].each(s, function(t) {
            e[t]=t;
          }), s=e;
        }(), f['default'].each(s, function(e, t) {
          const n=document.createElement('option'); n.innerHTML=t, n.setAttribute('value', e), u.__select.appendChild(n);
        }), l.updateDisplay(), d['default'].bind(l.__select, 'change', function() {
          const e=this.options[this.selectedIndex].value; u.setValue(e);
        }), l.domElement.appendChild(l.__select), l;
      } return a(t, e), t.prototype.setValue=function(t) {
        const n=e.prototype.setValue.call(this, t); return this.__onFinishChange&&this.__onFinishChange.call(this, this.getValue()), n;
      }, t.prototype.updateDisplay=function() {
    ...
    'use strict'; function o(e) {
      ...
      function t(n, o) {
        ...
        }i(this, t); const s=r(this, e.call(this, n, o)); var u=s; return s.__input=document.createElement('input'), s.__input.setAttribute('type', 'text'), d['default'].bind(s.__input, 'keyup', a), d['default'].bind(s.__input, 'change', a), d['default'].bind(s.__input, 'blur', l), d['default'].bind(s.__input, 'keydown', function(e) {
    ...
    'use strict'; function o(e) {
      ...
      const t=e.toString(); return t.indexOf('.')>-1?t.length-t.indexOf('.')-1:0;
    }t.__esModule=!0; const s=n(7); const u=o(s); const d=n(5); const c=o(d); const f=function(e) {
      function t(n, o, a) {
        i(this, t); const s=r(this, e.call(this, n, o)); const u=a||{}; return s.__min=u.min, s.__max=u.max, s.__step=u.step, c['default'].isUndefined(s.__step)?0===s.initialValue?s.__impliedStep=1:s.__impliedStep=Math.pow(10, Math.floor(Math.log(Math.abs(s.initialValue))/Math.LN10))/10:s.__impliedStep=s.__step, s.__precision=l(s.__impliedStep), s;
      } return a(t, e), t.prototype.setValue=function(t) {
        let n=t; return void 0!==this.__min&&n<this.__min?n=this.__min:void 0!==this.__max&&n>this.__max&&(n=this.__max), void 0!==this.__step&&n%this.__step!==0&&(n=Math.round(n/this.__step)*this.__step), e.prototype.setValue.call(this, n);
    ...
    'use strict'; function o(e) {
      ...
      const n=Math.pow(10, t); return Math.round(e*n)/n;
    }t.__esModule=!0; const s=n(12); const u=o(s); const d=n(9); const c=o(d); const f=n(5); const _=o(f); const p=function(e) {
      function t(n, o, a) {
        function l() {
          const e=parseFloat(m.__input.value); _['default'].isNaN(e)||m.setValue(e);
        } function s() {
          m.__onFinishChange&&m.__onFinishChange.call(m, m.getValue());
        } function u() {
          s();
        } function d(e) {
          const t=b-e.clientY; m.setValue(m.getValue()+t*m.__impliedStep), b=e.clientY;
        } function f() {
        ...
        }i(this, t); const h=r(this, e.call(this, n, o, a)); h.__truncationSuspended=!1; var m=h; var b=void 0; return h.__input=document.createElement('input'), h.__input.setAttribute('type', 'text'), c['default'].bind(h.__input, 'change', l), c['default'].bind(h.__input, 'blur', u), c['default'].bind(h.__input, 'mousedown', p), c['default'].bind(h.__input, 'keydown', function(e) {
    ...
    }t.__esModule=!0; const s=n(12); const u=o(s); const d=n(9); const c=o(d); const f=function(e) {
      function t(n, o, a, s, u) {
        function d(e) {
          document.activeElement.blur(), c['default'].bind(window, 'mousemove', f), c['default'].bind(window, 'mouseup', _), f(e);
        } function f(e) {
          e.preventDefault(); const t=h.__background.getBoundingClientRect(); return h.setValue(l(e.clientX, t.left, t.right, h.__min, h.__max)), !1;
        } function _() {
        ...
        }i(this, t); const p=r(this, e.call(this, n, o, {min: a, max: s, step: u})); var h=p; return p.__background=document.createElement('div'), p.__foreground=document.createElement('div'), c['default'].bind(p.__background, 'mousedown', d), c['default'].addClass(p.__background, 'slider'), c['default'].addClass(p.__foreground, 'slider-fg'), p.updateDisplay(), p.__background.appendChild(p.__foreground), p.domElement.appendChild(p.__background), p;
      } return a(t, e), t.prototype.updateDisplay=function() {
        const t=(this.getValue()-this.__min)/(this.__max-this.__min); return this.__foreground.style.width=100*t+'%', e.prototype.updateDisplay.call(this);
      }, t;
    }(u['default']); t['default']=f;
  }, function(e, t, n) {
    'use strict'; function o(e) {
      ...
      function t(n, o, a) {
        i(this, t); const l=r(this, e.call(this, n, o)); const s=l; return l.__button=document.createElement('div'), l.__button.innerHTML=void 0===a?'Fire':a, d['default'].bind(l.__button, 'click', function(e) {
    ...
    }t.__esModule=!0; const u=n(7); const d=o(u); const c=n(9); const f=o(c); const _=n(2); const p=o(_); const h=n(3); const m=o(h); const b=n(5); var g=o(b); const v=function(e) {
      function t(n, o) {
        function a(e) {
          ...
          const e=(0, m['default'])(this.value); e!==!1?(y.__color.__state=e, y.setValue(y.__color.toOriginal())):this.value=y.__color.toString();
        } function c() {
          ...
          e.preventDefault(); const t=y.__saturation_field.getBoundingClientRect(); let n=(e.clientX-t.left)/(t.right-t.left); let o=1-(e.clientY-t.top)/(t.bottom-t.top); return o>1?o=1:o<0&&(o=0), n>1?n=1:n<0&&(n=0), y.__color.v=o, y.__color.s=n, y.setValue(y.__color.toOriginal()), !1;
        } function b(e) {
          e.preventDefault(); const t=y.__hue_field.getBoundingClientRect(); let n=1-(e.clientY-t.top)/(t.bottom-t.top); return n>1?n=1:n<0&&(n=0), y.__color.h=360*n, y.setValue(y.__color.toOriginal()), !1;
        ...
        const e=(0, m['default'])(this.getValue()); if (e!==!1) {
          let t=!1; g['default'].each(p['default'].COMPONENTS, function(n) {
        ...
        }g['default'].extend(this.__temp.__state, this.__color.__state), this.__temp.a=1; const n=this.__color.v<.5||this.__color.s>.5?255:0; const o=255-n; g['default'].extend(this.__field_knob.style, {marginLeft: 100*this.__color.s-7+'px', marginTop: 100*(1-this.__color.v)-7+'px', backgroundColor: this.__temp.toHexString(), border: this.__field_knob_border+'rgb('+n+','+n+','+n+')'}), this.__hue_knob.style.marginTop=100*(1-this.__color.h/360)+'px', this.__temp.s=1, this.__temp.v=1, l(this.__saturation_field, 'left', '#fff', this.__temp.toHexString()), this.__input.value=this.__color.toString(), g['default'].extend(this.__input.style, {backgroundColor: this.__color.toHexString(), color: 'rgb('+n+','+n+','+n+')', textShadow: this.__input_textShadow+'rgba('+o+','+o+','+o+',.7)'});
      }, t;
    }(d['default']); var y=['-moz-', '-o-', '-webkit-', '-ms-', '']; t['default']=v;
  }, function(e, t, n) {
    'use strict'; function o(e) {
      return e&&e.__esModule?e:{'default': e};
    } function i(e, t, n) {
      const o=document.createElement('li'); return t&&o.appendChild(t), n?e.__ul.insertBefore(o, n):e.__ul.appendChild(o), e.onResize(), o;
    } function r(e, t) {
      const n=e.__preset_select[e.__preset_select.selectedIndex]; t?n.innerHTML=n.value+'*':n.innerHTML=n.value;
    } function a(e, t, n) {
      if (n.__li=t, n.__gui=e, U['default'].extend(n, {options: function(t) {
        if (arguments.length>1) {
          const o=n.__li.nextElementSibling; return n.remove(), s(e, n.object, n.property, {before: o, factoryArgs: [U['default'].toArray(arguments)]});
        } if (U['default'].isArray(t)||U['default'].isObject(t)) {
          const i=n.__li.nextElementSibling; return n.remove(), s(e, n.object, n.property, {before: i, factoryArgs: [t]});
        }
      }, name: function(e) {
      ...
      }}), n instanceof B['default']) {
        !function() {
          const e=new N['default'](n.object, n.property, {min: n.__min, max: n.__max, step: n.__step}); U['default'].each(['updateDisplay', 'onChange', 'onFinishChange', 'step'], function(t) {
            const o=n[t]; const i=e[t]; n[t]=e[t]=function() {
              const t=Array.prototype.slice.call(arguments); return i.apply(e, t), o.apply(n, t);
            };
        ...
        const o=function(t) {
          if (U['default'].isNumber(n.__min)&&U['default'].isNumber(n.__max)) {
            const o=n.__li.firstElementChild.firstElementChild.innerHTML; const i=n.__gui.__listening.indexOf(n)>-1; n.remove(); const r=s(e, n.object, n.property, {before: n.__li.nextElementSibling, factoryArgs: [n.__min, n.__max, n.__step]}); return r.name(o), i&&r.listen(), r;
          } return t;
        }; n.min=U['default'].compose(o, n.min), n.max=U['default'].compose(o, n.max);
      } else {
n instanceof O['default']?(z['default'].bind(t, 'click', function() {
  ...
  return t.style.borderLeftColor=n.__color.toString(), e;
      ...
      const n=e.getRoot(); const o=n.__rememberedObjects.indexOf(t.object); if (o!==-1) {
        let i=n.__rememberedObjectIndecesToControllers[o]; if (void 0===i&&(i={}, n.__rememberedObjectIndecesToControllers[o]=i), i[t.property]=t, n.load&&n.load.remembered) {
          const r=n.load.remembered; let a=void 0; if (r[e.preset])a=r[e.preset]; else {
            if (!r[Q]) return; a=r[Q];
          } if (a[o]&&void 0!==a[o][t.property]) {
            const l=a[o][t.property]; t.initialValue=l, t.setValue(l);
          }
        }
      }
    } function s(e, t, n, o) {
      if (void 0===t[n]) throw new Error('Object "'+t+'" has no property "'+n+'"'); let r=void 0; if (o.color)r=new j['default'](t, n); else {
        const s=[t, n].concat(o.factoryArgs); r=C['default'].apply(e, s);
      }o.before instanceof S['default']&&(o.before=o.before.__li), l(e, r), z['default'].addClass(r.domElement, 'c'); const u=document.createElement('span'); z['default'].addClass(u, 'property-name'), u.innerHTML=r.property; const d=document.createElement('div'); d.appendChild(u), d.appendChild(r.domElement); const c=i(e, d, o.before); return z['default'].addClass(c, oe.CLASS_CONTROLLER_ROW), r instanceof j['default']?z['default'].addClass(c, 'color'):z['default'].addClass(c, g(r.getValue())), a(e, c, r), e.__controllers.push(r), r;
    } function u(e, t) {
      return document.location.href+'.'+t;
    } function d(e, t, n) {
      const o=document.createElement('option'); o.innerHTML=t, o.value=t, e.__preset_select.appendChild(o), n&&(e.__preset_select.selectedIndex=e.__preset_select.length-1);
    } function c(e, t) {
      t.style.display=e.useLocalStorage?'block':'none';
    } function f(e) {
      const t=e.__save_row=document.createElement('li'); z['default'].addClass(e.domElement, 'has-save'), e.__ul.insertBefore(t, e.__ul.firstChild), z['default'].addClass(t, 'save-row'); const n=document.createElement('span'); n.innerHTML='&nbsp;', z['default'].addClass(n, 'button gears'); const o=document.createElement('span'); o.innerHTML='Save', z['default'].addClass(o, 'button'), z['default'].addClass(o, 'save'); const i=document.createElement('span'); i.innerHTML='New', z['default'].addClass(i, 'button'), z['default'].addClass(i, 'save-as'); const r=document.createElement('span'); r.innerHTML='Revert', z['default'].addClass(r, 'button'), z['default'].addClass(r, 'revert'); const a=e.__preset_select=document.createElement('select'); e.load&&e.load.remembered?U['default'].each(e.load.remembered, function(t, n) {
        d(e, n, n===e.preset);
      }):d(e, Q, !1), z['default'].bind(a, 'change', function() {
        for (let t=0; t<e.__preset_select.length; t++)e.__preset_select[t].innerHTML=e.__preset_select[t].value; e.preset=this.value;
      }), t.appendChild(a), t.appendChild(n), t.appendChild(o), t.appendChild(i), t.appendChild(r), q&&!function() {
        const t=document.getElementById('dg-local-explain'); const n=document.getElementById('dg-local-storage'); const o=document.getElementById('dg-save-locally'); o.style.display='block', 'true'===localStorage.getItem(u(e, 'isLocal'))&&n.setAttribute('checked', 'checked'), c(e, t), z['default'].bind(n, 'change', function() {
          e.useLocalStorage=!e.useLocalStorage, c(e, t);
        });
      }(); const l=document.getElementById('dg-new-constructor'); z['default'].bind(l, 'keydown', function(e) {
        ...
        const t=prompt('Enter a new preset name.'); t&&e.saveAs(t);
      ...
      const n={}; return U['default'].each(e.__rememberedObjects, function(o, i) {
        const r={}; const a=e.__rememberedObjectIndecesToControllers[i]; U['default'].each(a, function(e, n) {
    ...
    }; const v=n(18); const y=o(v); const w=n(19); const x=o(w); const E=n(20); var C=o(E); const A=n(7); var S=o(A); const k=n(8); var O=o(k); const T=n(15); var R=o(T); const L=n(13); var N=o(L); const M=n(14); var B=o(M); const H=n(16); var j=o(H); const P=n(21); var D=o(P); const V=n(22); const F=o(V); const I=n(9); var z=o(I); const G=n(5); var U=o(G); const X=n(23); const K=o(X); y['default'].inject(K['default']); const Y='dg'; const J=72; const W=20; var Q='Default'; var q=function() {
      try {
        return 'localStorage'in window&&null!==window.localStorage;
      } catch (e) {
        return !1;
      }
    }(); var Z=void 0; let $=!0; let ee=void 0; let te=!1; const ne=[]; var oe=function ie(e) {
      function t() {
        const e=n.getRoot(); e.width+=1, U['default'].defer(function() {
          e.width-=1;
        });
      } var n=this; let o=e||{}; this.domElement=document.createElement('div'), this.__ul=document.createElement('ul'), this.domElement.appendChild(this.__ul), z['default'].addClass(this.domElement, Y), this.__folders={}, this.__controllers=[], this.__rememberedObjects=[], this.__rememberedObjectIndecesToControllers=[], this.__listening=[], o=U['default'].defaults(o, {autoPlace: !0, width: ie.DEFAULT_WIDTH}), o=U['default'].defaults(o, {resizable: o.autoPlace, hideable: o.autoPlace}), U['default'].isUndefined(o.load)?o.load={preset: Q}:o.preset&&(o.load.preset=o.preset), U['default'].isUndefined(o.parent)&&o.hideable&&ne.push(this), o.resizable=U['default'].isUndefined(o.parent)&&o.resizable, o.autoPlace&&U['default'].isUndefined(o.scrollable)&&(o.scrollable=!0); let r=q&&'true'===localStorage.getItem(u(this, 'isLocal')); let a=void 0; if (Object.defineProperties(this, {parent: {get: function() {
        return o.parent;
...
n.parent?n.getRoot().preset=e:o.load.preset=e, m(this), n.revert();
        ...
        if (o.closed=!1, z['default'].addClass(this.domElement, ie.CLASS_MAIN), z['default'].makeSelectable(this.domElement, !1), q&&r) {
          n.useLocalStorage=!0; const l=localStorage.getItem(u(this, 'gui')); l&&(o.load=JSON.parse(l));
        ...
        void 0===o.closed&&(o.closed=!0); const s=document.createTextNode(o.name); z['default'].addClass(s, 'controller-name'); const d=i(n, s); const c=function(e) {
      ...
      this.__ul.removeChild(e.__li), this.__controllers.splice(this.__controllers.indexOf(e), 1); const t=this; U['default'].defer(function() {
        t.onResize();
      });
    }, destroy: function() {
      ...
      if (void 0!==this.__folders[e]) throw new Error('You already have a folder in this GUI by the name "'+e+'"'); const t={name: e, parent: this}; t.autoPlace=this.autoPlace, this.load&&this.load.folders&&this.load.folders[e]&&(t.closed=this.load.folders[e].closed, t.load=this.load.folders[e]); const n=new oe(t); this.__folders[e]=n; const o=i(this, n.domElement); return z['default'].addClass(o, 'folder'), n;
    }, open: function() {
      this.closed=!1;
    }, close: function() {
      this.closed=!0;
    }, onResize: function() {
      const e=this.getRoot(); if (e.scrollable) {
        const t=z['default'].getOffset(e.__ul).top; let n=0; U['default'].each(e.__ul.childNodes, function(t) {
      ...
      if (U['default'].isUndefined(Z)&&(Z=new F['default'], Z.domElement.innerHTML=x['default']), this.parent) throw new Error('You can only call remember on a top level GUI.'); const e=this; U['default'].each(Array.prototype.slice.call(arguments), function(t) {
      ...
      const e=this.load; return e.closed=this.closed, this.__rememberedObjects.length>0&&(e.preset=this.preset, e.remembered||(e.remembered={}), e.remembered[this.preset]=h(this)), e.folders={}, U['default'].each(this.__folders, function(t, n) {
...
this.getRoot().load.remembered?l(e||this.getRoot(), t):t.setValue(t.initialValue), t.__onFinishChange&&t.__onFinishChange.call(t, t.getValue());
      ...
      const t=0===this.__listening.length; this.__listening.push(e), t&&b(this.__listening);
    ...
    'use strict'; e.exports={load: function(e, t) {
      const n=t||document; const o=n.createElement('link'); o.type='text/css', o.rel='stylesheet', o.href=e, n.getElementsByTagName('head')[0].appendChild(o);
    }, inject: function(e, t) {
      const n=t||document; const o=document.createElement('style'); o.type='text/css', o.innerHTML=e; const i=n.getElementsByTagName('head')[0]; try {
        i.appendChild(o);
      } catch (r) {}
    }};
  }, function(e, t) {
    ...
    'use strict'; function o(e) {
      return e&&e.__esModule?e:{'default': e};
    }t.__esModule=!0; const i=n(10); const r=o(i); const a=n(13); const l=o(a); const s=n(14); const u=o(s); const d=n(11); const c=o(d); const f=n(15); const _=o(f); const p=n(8); const h=o(p); const m=n(5); const b=o(m); const g=function(e, t) {
      const n=e[t]; return b['default'].isArray(arguments[2])||b['default'].isObject(arguments[2])?new r['default'](e, t, arguments[2]):b['default'].isNumber(n)?b['default'].isNumber(arguments[2])&&b['default'].isNumber(arguments[3])?b['default'].isNumber(arguments[4])?new u['default'](e, t, arguments[2], arguments[3], arguments[4]):new u['default'](e, t, arguments[2], arguments[3]):b['default'].isNumber(arguments[4])?new l['default'](e, t, {min: arguments[2], max: arguments[3], step: arguments[4]}):new l['default'](e, t, {min: arguments[2], max: arguments[3]}):b['default'].isString(n)?new c['default'](e, t):b['default'].isFunction(n)?new _['default'](e, t, ''):b['default'].isBoolean(n)?new h['default'](e, t):null;
    }; t['default']=g;
  }, function(e, t) {
    ...
    'use strict'; function o(e) {
      ...
      if (!(e instanceof t)) throw new TypeError('Cannot call a class as a function');
    }t.__esModule=!0; const r=n(9); const a=o(r); const l=n(5); const s=o(l); const u=function() {
      function e() {
        i(this, e), this.backgroundElement=document.createElement('div'), s['default'].extend(this.backgroundElement.style, {backgroundColor: 'rgba(0,0,0,0.8)', top: 0, left: 0, display: 'none', zIndex: '1000', opacity: 0, WebkitTransition: 'opacity 0.2s linear', transition: 'opacity 0.2s linear'}), a['default'].makeFullscreen(this.backgroundElement), this.backgroundElement.style.position='fixed', this.domElement=document.createElement('div'), s['default'].extend(this.domElement.style, {position: 'fixed', display: 'none', zIndex: '1001', opacity: 0, WebkitTransition: '-webkit-transform 0.2s ease-out, opacity 0.2s linear', transition: 'transform 0.2s ease-out, opacity 0.2s linear'}), document.body.appendChild(this.backgroundElement), document.body.appendChild(this.domElement); const t=this; a['default'].bind(this.backgroundElement, 'click', function() {
          t.hide();
        });
      } return e.prototype.show=function() {
        const e=this; this.backgroundElement.style.display='block', this.domElement.style.display='block', this.domElement.style.opacity=0, this.domElement.style.webkitTransform='scale(1.1)', this.layout(), s['default'].defer(function() {
          e.backgroundElement.style.opacity=1, e.domElement.style.opacity=1, e.domElement.style.webkitTransform='scale(1)';
        });
      }, e.prototype.hide=function t() {
        const e=this; const t=function n() {
    ...
    e.exports=function() {
      const e=[]; return e.toString=function() {
        for (var e=[], t=0; t<this.length; t++) {
          const n=this[t]; n[2]?e.push('@media '+n[2]+'{'+n[1]+'}'):e.push(n[1]);
        } return e.join('');
      }, e.i=function(t, n) {
        'string'==typeof t&&(t=[[null, t, '']]); for (var o={}, i=0; i<this.length; i++) {
          const r=this[i][0]; 'number'==typeof r&&(o[r]=!0);
        } for (i=0; i<t.length; i++) {
          const a=t[i]; 'number'==typeof a[0]&&o[a[0]]||(n&&!a[2]?a[2]=n:n&&(a[2]='('+a[2]+') and ('+n+')'), e.push(a));
        }
      }, e;
    };
  }]);
