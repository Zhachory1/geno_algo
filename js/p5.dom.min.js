!(function(t, e) {
  ...
  function i(e, i, n) {
    ...
    var r = n ? new t.MediaElement(e) : new t.Element(e);
  ...
  ["div", "p", "span"].forEach(function(e) {
    var n = "create" + e.charAt(0).toUpperCase() + e.slice(1);
    ...
    (t.prototype.createRadio = function(e) {
      ...
      if (s.length > 1) {
        var l = s.length,
          ...
          h = s[1].name;
        o = 1;
        for (var d = 1; d < l; d++) a !== (h = s[d].name) && o++, (a = h);
      } else 1 === s.length && (o = 1);
      "object" == typeof e
        ...
        return (
          ...
          r.addEventListener(
            ...
            function(i) {
              ...
              for (var r = i.target.files, s = 0; s < r.length; s++) {
                var o = r[s],
                  l = new FileReader();
                (l.onload = n(o)),
    ...
    void 0 === navigator.mediaDevices.getUserMedia &&
      (navigator.mediaDevices.getUserMedia = function(t) {
        var e = navigator.webkitGetUserMedia || navigator.mozGetUserMedia;
        return e
    ...
    (t.MediaElement = function(e, i) {
      ...
      (this.elt.crossOrigin = "anonymous"),
        ...
        Object.defineProperty(n, "src", {
          ...
          set: function(t) {
            for (var i = 0; i < n.elt.children.length; i++)
